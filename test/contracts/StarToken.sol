...
/**
    ...
    Great features:
    variable% fee automatically distribute to all holders.
    
    When transferring token:
    0.143% fee auto collected

    - Of this transfer fee 35% is automatically added to the liquidity pool.
    - Another 35% fee automatically moved to STAR Investment fund.
    - Remaining 30% is burned.
...
contract StarToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 111111 10**10;
    ...
    uint256 public _liquidityFee = 0.005;
    ...
    // to recieve MATIC from uniswapV2Router when swapping
