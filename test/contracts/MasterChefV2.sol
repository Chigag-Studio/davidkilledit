...
// File interfaces/IStarReferral.sol



pragma solidity 0.6.12;

interface IStarReferral {
    /**
     * @dev Record referral.
     */
...
pragma solidity 0.6.12;
// MasterChef is the master of Star. It can make Star and he is a fair guy.
//
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_STAR_PER_BLOCK = 2000 * 10 ** 18;
    ...
    uint256 public totalStarInPools = 0;
    // STAR referral contract address.
    IStarReferral public starReferral;
    ...
    //actual STAR lef in MasterChef can be used in rewards, must excluding all in STAR pools
    ...
    function deposit(uint256 _pid, uint256 _amount, address _referrer) public nonReentrant {
        ...
        updatePool(_pid);
        if (_amount > 0 && address(starReferral) != address(0) && _referrer != address(0) && _referrer != msg.sender) {
    ...
    function setStarReferral(IStarReferral _starReferral) public onlyOwner {
    ...
    function payReferralCommission(address _user, uint256 _pending) internal {
        if (address(starReferral) != address(0) && referralCommissionRate > 0) {
            ...
            if (referrer != address(0) && commissionAmount > 0) {
                safeStarTransfer(referrer, commissionAmount);
